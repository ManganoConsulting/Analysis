function mousePressedInVarTree_CB( gui , ~ , eventData, ~)
%----------------------------------------------------------------------
    ...
    if eventData.isMetaDown  % right-click is like a Meta-button
        ...
        if ~isempty(treePath)
            if clickX <= (jtree.getPathBounds(treePath).x+gui.JavaImage_checked.getWidth)
                ...
                if any(strcmp(node.getName,{'States','State Derivatives','Inputs','Outputs','Flight Condition','Mass Property'}))
                    ...
                    updateShowData(gui,node.getName);
                    
                elseif ~node.isRoot && any(strcmp(char(node.getParent.getName),{'States','State Derivatives','Inputs','Outputs','Flight Condition','Mass Property'}))
