    ...
    methods (Access = private)
        ...
        function html = buildRibbonHtml(~)
            lines = {
                ...
                '<style>'
                'html,body{margin:0;padding:0;height:100%;background:transparent;font-family:"Segoe UI",Tahoma,Arial,sans-serif;font-size:12px;color:#1a1a1a;}'
                '.ribbon{position:absolute;inset:0;display:flex;flex-direction:column;background:linear-gradient(180deg,#f3f3f3 0%,#d9d9d9 100%);border-bottom:1px solid #b4b4b4;box-sizing:border-box;}'
                '.quick-access{display:flex;align-items:center;gap:4px;padding:4px 10px 0;height:28px;}'
                '.quick-button{width:24px;height:24px;padding:0;border:1px solid transparent;border-radius:3px;background:linear-gradient(180deg,#ffffff 0%,#e2e2e2 100%);box-shadow:0 1px 0 rgba(255,255,255,0.85) inset;display:flex;align-items:center;justify-content:center;cursor:pointer;transition:all .12s ease;}'
                '.quick-button:hover{border-color:#7ba6d8;box-shadow:0 0 0 1px rgba(123,166,216,0.45) inset;}'
                '.quick-button:active{border-color:#5b8ac9;background:linear-gradient(180deg,#e8f1ff 0%,#ccdef6 100%);}'
                '.quick-button:focus-visible{outline:2px solid #0e67d2;outline-offset:1px;}'
                '.quick-button img{width:16px;height:16px;image-rendering:-webkit-optimize-contrast;}'
                '.quick-separator{width:1px;height:16px;background:#909090;margin:0 6px;}'
                '.chunk-row{flex:1;display:flex;align-items:stretch;padding:0 8px 6px;gap:0;}'
                '.chunk{position:relative;display:flex;flex-direction:column;align-items:stretch;padding:4px 12px 18px;gap:8px;}'
                '.chunk:not(:last-child)::after{content:"";position:absolute;top:8px;right:0;width:1px;height:calc(100% - 16px);background:#bcbcbc;}'
                '.chunk:first-child{padding-left:4px;}'
                '.chunk-body{display:flex;align-items:flex-start;gap:12px;}'
                '.chunk-body.column{flex-direction:column;gap:8px;}'
                '.chunk-footer{margin-top:auto;text-align:center;font-size:10px;text-transform:uppercase;letter-spacing:1px;color:#626262;}'
                '.chunk-file .chunk-body{gap:10px;}'
                '.chunk-run .chunk-body{gap:10px;}'
                '.chunk-actions .chunk-body{gap:12px;}'
                '.chunk-options{min-width:190px;}'
                '.chunk-settings{min-width:190px;}'
                '.button-base{display:flex;align-items:center;justify-content:center;gap:6px;border:1px solid transparent;border-radius:4px;background:linear-gradient(180deg,#ffffff 0%,#e5e5e5 100%);box-shadow:0 1px 0 rgba(255,255,255,0.85) inset;color:#1a1a1a;cursor:pointer;transition:all .12s ease;}'
                '.button-base:hover{border-color:#7ba6d8;box-shadow:0 0 0 1px rgba(123,166,216,0.45) inset,0 1px 2px rgba(0,0,0,0.15);}'
                '.button-base:active{border-color:#5b8ac9;background:linear-gradient(180deg,#e8f1ff 0%,#ccdef6 100%);}'
                '.button-base:focus-visible{outline:2px solid #0e67d2;outline-offset:1px;}'
                '.button-vertical{flex-direction:column;min-width:72px;height:78px;padding:6px 10px 14px;}'
                '.button-small{min-width:76px;}'
                '.button-horizontal{flex-direction:row;align-items:center;justify-content:flex-start;min-width:0;height:auto;padding:6px 14px;}'
                '.label{display:block;font-size:11px;font-weight:600;text-align:center;line-height:1.2;color:#1a1a1a;white-space:normal;}'
                '.label.small{font-size:10px;text-align:left;}'
                '.split{position:relative;display:flex;}'
                '.split.vertical{flex-direction:column;align-items:stretch;padding-bottom:18px;}'
                '.split.vertical .split-main{width:100%;}'
                '.split.vertical .split-trigger{position:absolute;bottom:2px;left:50%;transform:translateX(-50%);width:18px;height:16px;border:1px solid transparent;border-radius:3px;background:linear-gradient(180deg,#fdfdfd 0%,#e6e6e6 100%);display:flex;align-items:center;justify-content:center;cursor:pointer;transition:all .12s ease;}'
                '.split.horizontal{align-items:stretch;}'
                '.split.horizontal .split-main{padding-right:30px;}'
                '.split.horizontal .split-trigger{position:absolute;top:50%;right:6px;transform:translateY(-50%);width:18px;height:18px;border:1px solid transparent;border-radius:3px;background:linear-gradient(180deg,#fdfdfd 0%,#e6e6e6 100%);display:flex;align-items:center;justify-content:center;cursor:pointer;transition:all .12s ease;}'
                '.split-trigger:hover{border-color:#7ba6d8;box-shadow:0 0 0 1px rgba(123,166,216,0.45) inset;}'
                ...
                '.menu{position:absolute;top:100%;left:0;margin-top:4px;display:none;flex-direction:column;min-width:180px;background:#ffffff;border:1px solid #c3c3c3;border-radius:4px;box-shadow:0 12px 28px rgba(0,0,0,0.18);padding:4px 0;z-index:100;}'
                ...
                '.field{display:flex;flex-direction:column;gap:4px;font-size:11px;color:#1a1a1a;}'
                '.field-label{font-size:10px;text-transform:uppercase;letter-spacing:0.6px;color:#545454;}'
                '.checkbox{display:flex;align-items:center;gap:6px;font-size:11px;color:#1a1a1a;}'
                '.checkbox input{margin:0;}'
                'select{font:11px "Segoe UI",Tahoma,Arial,sans-serif;padding:3px 6px;border:1px solid #b2b2b2;border-radius:3px;background:#ffffff;color:#1f1f1f;min-width:140px;}'
                'select:focus{outline:1px solid #0e67d2;outline-offset:0;}'
                '.icon-large{width:28px;height:28px;image-rendering:-webkit-optimize-contrast;}'
                '.icon-medium{width:24px;height:24px;image-rendering:-webkit-optimize-contrast;}'
                '.icon-small{width:18px;height:18px;image-rendering:-webkit-optimize-contrast;}'
                '</style>'
                '</head>'
                '<body>'
                '<div class="ribbon" id="ribbonSurface">'
                '  <div class="quick-access" role="toolbar">'
                '    <button type="button" class="quick-button" data-role="primary" data-command="new" title="Create new item">'
                '      <img id="icon-new-quick" alt="New">'
                '    </button>'
                '    <button type="button" class="quick-button" data-role="primary" data-command="open" title="Open existing item">'
                '      <img id="icon-open-quick" alt="Open">'
                '    </button>'
                '    <button type="button" class="quick-button" data-role="primary" data-command="save" data-option="project" title="Save project">'
                '      <img id="icon-save-quick" alt="Save">'
                '    </button>'
                '    <button type="button" class="quick-button" data-role="primary" data-command="run" data-option="run" title="Run">'
                '      <img id="icon-run-quick" alt="Run">'
                '    </button>'
                '    <div class="quick-separator"></div>'
                '  </div>'
                '  <div class="chunk-row">'
                '    <div class="chunk chunk-file">'
                ...
                '            <img id="icon-new" alt="New" class="icon-large">'
                ...
                '            <img id="icon-open" alt="Open" class="icon-large">'
                ...
                '            <img id="icon-load" alt="Load" class="icon-large">'
                ...
                '            <img id="icon-save" alt="Save" class="icon-large">'
                ...
                '        </div>'
                '      </div>'
                '      <div class="chunk-footer">File</div>'
                '    </div>'
                '    <div class="chunk chunk-run">'
                '      <div class="chunk-body">'
                '        <div class="split vertical">'
                ...
                '            <img id="icon-run" alt="Run" class="icon-large">'
                '            <span class="label">Auto Run Cases</span>'
                '          </button>'
                ...
                '        </div>'
                '      </div>'
                '      <div class="chunk-footer">Run</div>'
                '    </div>'
                '    <div class="chunk chunk-actions">'
                '      <div class="chunk-body">'
                '        <button type="button" class="button-base button-vertical button-small" data-role="primary" data-command="batch" data-option="add" title="Add new run cases">'
                '          <img id="icon-add" alt="Add to Batch" class="icon-medium">'
                '          <span class="label">Add to Batch</span>'
                '        </button>'
                '        <div class="split vertical">'
                '          <button type="button" class="button-base button-vertical button-small split-main" data-role="primary" data-command="table" data-option="clear" title="Table options">'
                '            <img id="icon-table" alt="Table" class="icon-medium">'
                ...
                '        </div>'
                '        <div class="split vertical">'
                '          <button type="button" class="button-base button-vertical button-small split-main" data-role="primary" data-command="report" data-option="pdf" title="Generate analysis report">'
                '            <img id="icon-report" alt="Report" class="icon-medium">'
                ...
                '        </div>'
                '      </div>'
                '      <div class="chunk-footer">Actions</div>'
                '    </div>'
                '    <div class="chunk chunk-options">'
                '      <div class="chunk-body column">'
                '        <label class="field">'
                ...
                '        </label>'
                '      </div>'
                '      <div class="chunk-footer">Options</div>'
                '    </div>'
                '    <div class="chunk chunk-settings">'
                '      <div class="chunk-body column">'
                '        <label class="field">'
                ...
                '            <img id="icon-settings" alt="Settings" class="icon-small">'
                ...
                '        </div>'
                '      </div>'
                '      <div class="chunk-footer">Settings</div>'
                '    </div>'
                '  </div>'
                '</div>'
                '<script>'
                ...
                '      setIcon("icon-new-quick", icons.new);'
                '      setIcon("icon-open", icons.open);'
                '      setIcon("icon-open-quick", icons.open);'
                '      setIcon("icon-load", icons.load);'
                '      setIcon("icon-save", icons.save);'
                '      setIcon("icon-save-quick", icons.save);'
                '      setIcon("icon-run", icons.run);'
                '      setIcon("icon-run-quick", icons.run);'
