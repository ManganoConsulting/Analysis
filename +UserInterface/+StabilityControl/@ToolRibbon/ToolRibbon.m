    ...
    methods (Access = private)
        ...
        function html = buildRibbonHtml(~)
            lines = {
                ...
                '.ribbon-surface{position:absolute;inset:0;display:flex;align-items:stretch;gap:0;padding:4px 10px 6px;background:linear-gradient(180deg,#f7f7f7 0%,#dedede 100%);border-bottom:1px solid #bcbcbc;box-sizing:border-box;}'
                '.group{position:relative;display:flex;flex-direction:column;align-items:stretch;gap:4px;padding:0 10px 4px;border-right:1px solid #b6b6b6;min-height:100%;}'
                '.group:last-of-type{border-right:none;}'
                '.group-body{display:flex;gap:6px;align-items:flex-start;flex:1 1 auto;}'
                '.group-body.column{flex-direction:column;}'
                '.group-label{text-align:center;font-size:10px;font-weight:600;letter-spacing:0.8px;color:#5a5a5a;text-transform:uppercase;margin-top:auto;padding-top:2px;}'
                '.button-base{display:flex;align-items:center;justify-content:center;gap:6px;border:1px solid #b7b7b7;border-radius:3px;background:linear-gradient(180deg,#fefefe 0%,#e3e3e3 100%);box-shadow:0 1px 0 rgba(255,255,255,0.85) inset;color:#1f1f1f;cursor:pointer;padding:6px;transition:border-color .12s ease,box-shadow .12s ease,background .12s ease;}'
                ...
                '.button-vertical{flex-direction:column;min-width:60px;height:72px;padding:6px 6px 18px;gap:4px;position:relative;}'
                '.button-horizontal{flex-direction:row;justify-content:flex-start;min-width:0;padding:6px 12px;min-height:40px;}'
                '.button-horizontal.compact{min-height:34px;padding:4px 10px;}'
                '.button-wide{min-width:170px;}'
                '.label{text-transform:uppercase;font-size:10px;font-weight:600;letter-spacing:0.4px;color:#2f2f2f;text-align:center;}'
                '.label.small{text-transform:none;font-size:11px;letter-spacing:0.2px;text-align:left;}'
                '.icon-box{width:28px;height:28px;border-radius:5px;background:linear-gradient(180deg,#fefefe 0%,#ececec 100%);display:flex;align-items:center;justify-content:center;box-shadow:0 1px 0 rgba(255,255,255,0.85) inset;}'
                '.icon-box.small{width:22px;height:22px;border-radius:4px;}'
                '.icon-box img{width:18px;height:18px;image-rendering:-webkit-optimize-contrast;}'
                ...
                '.menu{position:absolute;top:100%;left:0;margin-top:4px;display:none;flex-direction:column;min-width:180px;background:#ffffff;border:1px solid #c3c3c3;border-radius:4px;box-shadow:0 12px 28px rgba(0,0,0,0.18);padding:4px 0;z-index:20;}'
