    ...
    methods (Access = private)
        ...
        function html = buildRibbonHtml(~)
            lines = {
                ...
                '.ribbon-surface{position:absolute;inset:0;display:flex;align-items:flex-start;gap:8px;padding:6px 10px;background:linear-gradient(180deg,#f8f8f8 0%,#e3e3e3 100%);border-bottom:1px solid #bcbcbc;box-sizing:border-box;}'
                '.group{display:flex;flex-direction:column;min-width:140px;padding:4px 8px 6px;background:rgba(255,255,255,0.95);border:1px solid #c3c3c3;border-radius:4px;box-shadow:0 1px 0 rgba(255,255,255,0.85) inset;}'
                '.group-body{display:flex;gap:6px;}'
                ...
                '.button-vertical{flex-direction:column;min-width:56px;height:68px;padding:6px 6px;gap:4px;}'
                '.button-horizontal{flex-direction:row;justify-content:flex-start;min-width:0;padding:6px 10px;}'
                '.label{text-transform:uppercase;font-size:10px;font-weight:600;letter-spacing:0.4px;color:#2c2c2c;}'
                '.label.small{text-transform:none;font-size:10px;font-weight:600;letter-spacing:0.2px;line-height:1.3;text-align:left;white-space:normal;}'
                '.icon-box{width:30px;height:30px;border-radius:5px;background:linear-gradient(180deg,#fefefe 0%,#ededed 100%);display:flex;align-items:center;justify-content:center;box-shadow:0 1px 0 rgba(255,255,255,0.9) inset;}'
                '.icon-box.small{width:20px;height:20px;border-radius:4px;}'
                '.icon-box img{width:20px;height:20px;image-rendering:-webkit-optimize-contrast;}'
                '.icon-box.small img{width:16px;height:16px;}'
                '.split{position:relative;display:inline-flex;}'
                '.split-main{border-radius:4px;width:100%;}'
                '.split.vertical .split-main{padding-bottom:18px;}'
                '.split.horizontal .split-main{padding-right:24px;}'
                '.split-trigger{position:absolute;display:flex;align-items:center;justify-content:center;width:18px;height:18px;border:1px solid transparent;border-radius:3px;background:linear-gradient(180deg,#fdfdfd 0%,#e6e6e6 100%);cursor:pointer;transition:all .12s ease;z-index:1;}'
                ...
                '.split.vertical .split-trigger{bottom:6px;left:50%;transform:translateX(-50%);}'
                '.split.horizontal .split-trigger{top:50%;right:6px;transform:translateY(-50%);}'
                ...
                '.group[data-group="file"] .group-body{gap:6px;}'
                '.group[data-group="actions"] .button-base,.group[data-group="actions"] .split,.group[data-group="settings"] .split{width:170px;max-width:170px;}'
                '.group[data-group="settings"] .button-base{width:170px;max-width:170px;}'
                '.button-vertical .label,.button-vertical .label.small{text-align:center;}'
                'select{font:11px "Segoe UI",Tahoma,Arial,sans-serif;padding:3px 6px;border:1px solid #b2b2b2;border-radius:3px;background:#ffffff;color:#1f1f1f;min-width:130px;}'
