classdef FrequencyResponseEditorApp < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function syncOutputDataIndices(app)
            app.OutputDataIndexArray = 1:numel(app.OrderTable.Data);
        end
...
%         end
        ...
        function onTableEdit(app, ~, event)
            ...
            if event.NewData
                ...
                % Find the title of the object in the listbox
            ...
            if all(colVals)
                ...
                % For partial or no selections set header checkbox to false
...
%             end
        ...
        function onMoveUp(app, ~)
            ...
            if idx > 1
                [items{idx-1}, items{idx}] = deal(items{idx}, items{idx-1});
                app.OrderTable.Data = items;
                app.OrderTable.Selection = [idx-1,1];
                syncOutputDataIndices(app);
            end
            focusUIFigure(app);
        end
