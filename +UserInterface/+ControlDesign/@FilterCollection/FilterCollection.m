...
%                 obj.ContextPane.repaint();%repaint a JFrame jframe in this case 
            ...
            obj.FiltTableModel = javax.swing.table.DefaultTableModel(obj.FilterCollTableData,{'Name', 'Type', 'Units'});
            ...
            w2 = 160;column1 = obj.FiltJTable.getColumnModel().getColumn(1);column1.setPreferredWidth(w2);column1.setMinWidth(w2);%column1.setMaxWidth(w2); 
            w3 = 80; column2 = obj.FiltJTable.getColumnModel().getColumn(2);column2.setPreferredWidth(w3);column2.setMinWidth(w3);%column1.setMaxWidth(w2); 
...
%             obj.FiltJTable.getColumnModel.getColumn(3).setCellEditor(com.jidesoft.grid.BooleanCheckBoxCellEditor); 
            ...
            % Units ComboBox
            comboBox_Units = javax.swing.JComboBox(obj.FilterUnits);
            comboBox_Units.setEditable(false);

            editor_Units = javax.swing.DefaultCellEditor(comboBox_Units);
            obj.FiltJTable.getColumnModel.getColumn(2).setCellEditor(editor_Units); 
        ...
        function dataUpdatedInFilterTable( obj , hModel , hEvent ) 
            ...
            switch modifiedCol
                ...
                case 1
                    ...
                    updateFiltMapTable( obj );
                case 2
                    obj.Filters(modifiedRow + 1).Units = hModel.getValueAt(modifiedRow,modifiedCol);
                    updateFiltParamTable( obj );
                    updateFiltMapTable( obj );
            end
