...
% %     obj.RunSelJButton = runSelJButton;
    ...
    % Stab Edit Button             
    stabJButton = javaObjectEDT('com.mathworks.toolstrip.components.TSSplitButton');
    ...
    set(stabJButtonH, 'DropDownActionPerformedCallback',@obj.stabDropMenu);
    ...
    % FR Edit Button             
    frJButton = javaObjectEDT('com.mathworks.toolstrip.components.TSSplitButton');
    ...
    set(frJButtonH, 'DropDownActionPerformedCallback',@obj.frDropMenu);
