...
%             jmenu.add(menuItem4);
        ...
        function frDropMenu( obj , hobj  , eventdata )
            ...
            menuItem1 = javaObjectEDT('javax.swing.JMenuItem','<html>Frequency Response Editor - Multi',blEditorIcon);
            menuItem1h = handle(menuItem1,'CallbackProperties');
            set(menuItem1h,'ActionPerformedCallback',@obj.menuNewFREditor);

            menuItem2 = javaObjectEDT('javax.swing.JMenuItem','<html>Frequency Response Editor - Single',stabIcon);
            menuItem2h = handle(menuItem2,'CallbackProperties');
