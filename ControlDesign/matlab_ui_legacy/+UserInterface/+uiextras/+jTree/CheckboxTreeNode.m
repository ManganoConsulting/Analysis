classdef CheckboxTreeNode < UserInterface.uiextras.jTree.TreeNode
    ...
    %   placed on a UserInterface.uiextras.jTree.CheckboxTree control.
    %
    % Syntax:
    %   nObj = UserInterface.uiextras.jTree.CheckboxTreeNode
    %   nObj = UserInterface.uiextras.jTree.CheckboxTreeNode('Property','Value',...)
    %
    %   The CheckboxTree contains all properties and methods of the
    %   <a href="matlab:doc UserInterface.uiextras.jTree.TreeNode">UserInterface.uiextras.jTree.TreeNode</a>, plus the following:
    %
    ...
    %
    % Notes:
    %   - The CheckboxTreeNode may be also used on a UserInterface.uiextras.jTree.Tree
    ...
    %           UserInterface.uiextras.jTree.TreeNode,
    %
    %
    ...
    methods
        function nObj = CheckboxTreeNode(varargin)
            ...
            nObj = nObj@UserInterface.uiextras.jTree.TreeNode(varargin{:});
    ...
    methods
        ...
        function nObjCopy = copy(nObj,NewParent)
            ...
            nObjCopy = copy@UserInterface.uiextras.jTree.TreeNode(nObj,NewParent);
    ...
    methods
        ...
        function value = get.Checked(nObj)
            value = true(1,0);
            if ~isempty(nObj.Tree) && isa(nObj.Tree,'UserInterface.uiextras.jTree.CheckboxTree')
