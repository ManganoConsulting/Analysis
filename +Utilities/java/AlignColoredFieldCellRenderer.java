// AlignColoredFieldCellRenderer - Modified TableCellRenderer for colored cells
...
public class AlignColoredFieldCellRenderer extends DefaultTableCellRenderer implements TableCellRenderer
{
	...
	// Constructors
	public AlignColoredFieldCellRenderer()
	{
		this(new Color(0.925F, 0.914F, 0.847F));  // gray
	}

	public AlignColoredFieldCellRenderer(Color bgcolor)
	{
		super();
		_bgcolor = bgcolor;
		//setOpaque(false);
	...
	public AlignColoredFieldCellRenderer(Color bgcolor, Color fgcolor)
	{
		super();
		_bgcolor = bgcolor;
		_fgcolor = fgcolor;
	...
	public AlignColoredFieldCellRenderer(float[] bgrgb)
	{
		this(new Color(bgrgb[0], bgrgb[1], bgrgb[2]));
	}

	public AlignColoredFieldCellRenderer(float[] bgrgb, float[] fgrgb)
	{
		this(new Color(bgrgb[0], bgrgb[1], bgrgb[2]), 
             new Color(fgrgb[0], fgrgb[1], fgrgb[2]));
	}

	public AlignColoredFieldCellRenderer(float r, float g, float b)
	{
		super();
